...
class Baratheon(Character):
    ...
    def __repr__(self):
        """String representation of the Baratheon character."""
        return f"<bound method {self.family_name}.__repr__ of Vector: ({self.family_name}, {self.eyes}, {self.hairs})>"
    
class Lannister(Character):
    """Derived class representing a Lannister character."""
    def __init__(self, first_name, family_name = "Lannister", eyes = "blue", hairs = "light"):
        super().__init__(first_name = first_name, is_alive = True)
        self.family_name = family_name 
        self.eyes = eyes
        self.hairs = hairs
